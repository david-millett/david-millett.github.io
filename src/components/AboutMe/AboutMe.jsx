...
// Icons
import { FaRegSmile, FaRegGrinWink } from 'react-icons/fa'

const AboutMe = () => {
    return (
        <main className={styles.container}>
            <div className="headingIntro">
                <h1 id='aboutme'><span className={`${styles.logo} ${styles.open}`}><FaRegSmile /></span><span className={`${styles.logo} ${styles.wink}`}><FaRegGrinWink /></span>About Me</h1>
